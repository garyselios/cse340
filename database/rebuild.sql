...
-- Includes: ENUM types, all tables, relationships,
-- sample data, and updates from assignments
-- =============================================
-- Drop tables if exist (in correct order to avoid foreign key conflicts)
...
-- =============================================
-- Link inventory to classification
...
-- Update image paths: from /images/whatever.jpg to /images/vehicles/whatever.jpg
UPDATE public.inventory
...
VALUES (
        ...
        'User',
        'admin@cse340.com',
        '$2a$10$Hv5cQqX8fJqj9zL6m7n8oP9qR0sT1uV2wX3yZ4aB5cD6eF7gH8iJ9kL0',
        'Admin'
    );
-- Sample client user (password: Password123!)
INSERT INTO public.account (
        account_firstname,
        account_lastname,
        account_email,
